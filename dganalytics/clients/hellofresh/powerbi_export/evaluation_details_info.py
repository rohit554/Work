...
def export_evaluation_details_info(spark: SparkSession, tenant: str):
...
a.queueId queueKey,
a.wrapUpCode
from gpc_hellofresh.dim_evaluations a, gpc_hellofresh.dim_evaluation_forms b, gpc_hellofresh.fact_evaluation_total_scores c,
