from dganalytics.clients.holden.utils.utils import (
    extract_mongo_colxn, get_minimum_processing_date, rundate_range_generator, export_dataframe_to_csv )
from dganalytics.clients.holden.utils.mongo_utils import (
    aggregate_mongo_colxn, drop_mongo_colxn, get_config_mongo, upsertone_mongo_colxn)
from dganalytics.clients.holden.analytics.configs import config
import argparse
import os
from dganalytics.clients.holden.utils.utils import timedelta, date, datetime
...
def extract_from_mongo(env, database_name, stage_name, step_name, rundate,):
    ...
    config_out_partitioned = config[f'{stage_name}']['partition_by']
