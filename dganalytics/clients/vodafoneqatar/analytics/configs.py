...
config = {
    ...
    "User_FCR_KPI_Data": {
        ...
        'primary_key': ['user_id', 'date', 'kpi','siebel_id'  ],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "User_AHT_KPI_Data": {
        ...
        'primary_key': ['date', 'kpi', 'user_id','siebel_id'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "Call_Volume": {
    ...
    "JSR_Process_KPI_Data": {
        ...
        'output_columns': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'services', 'site', 'date', 'value1', 'value2', 'kpi'],
        'primary_key': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'site', 'date','kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
}
