...
config = {
    ...
    "Raw_FCR": {
        ...
        'collection': "FCR",
        'load_timestamp_field': "insertion_timestamp",
        'output_columns': ['owner', 'account_type', 'agent', 'comments', 'journey', 'counts', 'created_month', 'description', 'check', 'activity_num', 'type', 'crm_segment', 'date_1', 'account_num', 'service_type', 'times', 'created_year', 'resolution_code', 'user_id', 'location', 'state', 'category', 'date', 'status'],
        'primary_key': ['owner', 'account_type', 'agent', 'account_num', 'service_type', 'resolution_code', 'user_id'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "User_FCR_KPI_Data": {
        ...
        'collection': "FCR",
        'load_timestamp_field': "insertion_timestamp",
        'output_columns': ['user_id', 'date',  'value1', 'value2', 'kpi'],
        'primary_key': ['user_id', 'date', 'kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "User_AHT_KPI_Data": {
        ...
        'output_columns': ['date', 'kpi', 'user_id', 'value1', 'value2'],
        'primary_key': ['date', 'kpi', 'user_id'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "Call_Volume": {
        ...
        'primary_key': ['answd', 'answd_in_threshold', 'aban_in_5_secs', 'aban_calls', 'offered', 'report_date', 'location', 'lob', 'segment_type', 'language'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "User_Details": {
        ...
        'primary_key': ['location', 'first_name', 'last_name', 'line_manager', 'role', 'sub_lob', 'user_id', 'lob', 'image', 'lm_user_id', 'cms_name', 'email_id', 'gender', 'team_leader', 'language'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "JSR_KPI_User_Team_Target": {  # No OutPUt
        ...
        'primary_key': ['kpi', 'team_id', 'target', 'weightage', 'user_id', 'date'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "JSR_Process_Forecast_Data": {
        ...
        'primary_key': ['forecast', 'report_date', 'lob', 'segment_type', 'location', 'language', 'actual'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "JSR_KPI_Team_Target": {
        ...
        'primary_key': ['kpi', 'team_id', 'target', 'weightage', 'date'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "User_KPI_Data": {
        ...
        'output_columns': ['user_id', 'date', 'value1', 'value2', 'kpi'],
        'primary_key': ['user_id', 'date', 'value1', 'value2', 'kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "JSR_Top_Reason_Data": {
    ...
    "JSR_Process_TNPS_KPI_Data_to_All_Process": {
        ...
        'primary_key': ['location', 'language', 'segment_type', 'services', 'date', 'value1', 'value2', 'kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "Process_AHT_KPI_Data_to_All_Process": {
        ...
        'output_columns': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'services', 'site', 'date', 'value1', 'value2', 'kpi'],
        'primary_key': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'services', 'site', 'date', 'value1', 'value2', 'kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    ...
    "JSR_Process_FCR_KPI_to_All_Process": {
        ...
        'output_columns': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'services', 'site', 'date', 'value1', 'value2', 'kpi'],
        'primary_key': ['location', 'segment_type', 'services', 'date', 'value1', 'value2', 'kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "Admin_Login": {
        ...
        'primary_key': ['email_id', 'avaya_name', 'first_name', 'last_name', 'siebel_id'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
    "JSR_AHT_KPI_Data": {
    ...
    "JSR_Process_KPI_Data": {
        ...
        'output_columns': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'services', 'site', 'date', 'value1', 'value2', 'kpi'],
        'primary_key': ['location', 'lobs', 'language', 'arpu_segment', 'segment_type', 'site', 'date', 'value1', 'value2', 'kpi'],
        'output_type': ['MERGED'],
        'renamed_columns': {},
    },
}
