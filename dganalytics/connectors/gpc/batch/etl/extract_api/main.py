...
from dganalytics.connectors.gpc.gpc_utils import get_dbname, gpc_request, extract_parser, gpc_utils_logger, process_raw_data
from dganalytics.connectors.gpc.gpc_utils import check_prev_gpc_extract, update_raw_table, get_prev_extract_data
import traceback
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.error(f"Error Occured in GPC Extraction for {extract_date}_{tenant}_{api_name}")
