...
if __name__ == "__main__":
    ...
    spark = get_spark_session(app_name="gpc_extract_routing_queues", tenant=tenant, default_db=db_name)

    print("Extracting routing_queues", tenant)
    df = gpc_request(spark, tenant, 'routing_queues', run_id, extract_date)
