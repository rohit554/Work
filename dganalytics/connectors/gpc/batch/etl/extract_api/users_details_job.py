...
from dganalytics.connectors.gpc.gpc_utils import get_api_url, gpc_request, extract_parser, authorize, get_dbname, get_interval
...
if __name__ == "__main__":
    ...
    spark = get_spark_session(
        app_name="gpc_users_details_batch_job", tenant=tenant, default_db=db_name)
