...
def create_dim_tables(spark: SparkSession, db_name: str):
    ...
    spark.sql(
        f"""create table if not exists {db_name}.fact_conversation_surveys
            (   
                conversationId string,
            ...
            LOCATION '{db_path}/{db_name}/fact_conversation_surveys'
            """
    )
    ...
    spark.sql(
        f"""CREATE TABLE IF NOT EXISTS {db_name}.fact_speechandtextanalytics
            (   
                conversationId string,
            ...
            USING DELTA
            LOCATION '{db_path}/{db_name}/fact_speechandtextanalytics'
            """
    )
