...
pipeline = [
    {
        ...
        '$project': {
            ...
            'quiz_end_date': '$questionnaire.end_date', 
...
schema = StructType([StructField('answered_date', StringType(), True),
                    ...
                    StructField('quiz_start_time', StringType(), True),
                    StructField('quiz_end_date', StringType(), True),
                    StructField('quiz_end_time', StringType(), True)])
...
def get_quizzes(spark):
    ...
    df = spark.sql("""
                    select  distinct cast(answered_date as date) answeredDate,
                            ...
                            cast(quiz_start_time as date) quizStartTime,
                            cast(quiz_end_date as date) quizEndDate,
                            cast(quiz_end_time as date) quizEndTime,
                    from quizzes
                """)
    '''
